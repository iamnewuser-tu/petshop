...
<div class="container-fluid">
	<div class="col-sm-3">
		...
		<h2><a href="${pageContext.request.contextPath}/user/edit?username=${user.userName}">Personal Information</a></h2>
	</div>
	<div class="col-sm-9">
		<h2>Account Dashboard</h2><hr />
		<div class="container-fluid jumbotron">
			<h3>Personal Information</h3><h4><a href="${pageContext.request.contextPath}/user/edit">Edit</a></h4><br /><br />
